...
class AugmentedFacesView extends React.Component {
  ...
  addAugmentedFace = ({ model, texture }) => {
    ...
    return NativeModules.SceneformAugmentedFacesModule.addFaceModel(
      findNodeHandle(this),
      mModel,
      mTexture
    );
  ...
  takeScreenshot = () => {
    return NativeModules.SceneformAugmentedFacesModule.takeSnapshot(
      findNodeHandle(this)
    );
  };
  ...
  startVideoRecording = async () => {
    ...
    const recording =
      await NativeModules.SceneformAugmentedFacesModule.startVideoRecording(
        findNodeHandle(this)
      );
    if (recording) {
  ...
  stopVideoRecording = () => {
    ...
    return NativeModules.SceneformAugmentedFacesModule.stopVideoRecording(
      findNodeHandle(this)
    );
  };
...
const NativeArView = requireNativeComponent(
